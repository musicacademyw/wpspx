...
/*
 * Spektrix donate shoertcode
 *
 */

function wpspxdonate()
{
	ob_start();
	?>
	<spektrix-donate client-name="<?php echo SPEKTRIX_USER; ?>" custom-domain="<?php echo SPEKTRIX_CUSTOM_URL; ?>" fund-id="" id="selectfundcomponent">
		...
		<div class="wpspx-row">
			...
			<div class="wpspx-column">
				<button class="button button btn button-secondary" data-clear-donation>Clear Donation</button>
			</div>
		</div>
...
add_shortcode( 'wpspx-donate', 'wpspxdonate' );
