...
function wpspx_settings_init(  ) {
	...
	add_settings_section(
		...
		__( 'Your section description', 'wpspx' ),
	...
	add_settings_field(
		'wpspx_text_field_0',
		__( 'Settings field description', 'wpspx' ),
		'wpspx_text_field_0_render',
		'wpspxPluginPage',
		'wpspx_wpspxPluginPage_section'
	);
...
// Client Account Name
function wpspx_text_field_0_render(  ) {

	$options = get_option( 'wpspx_settings' );
	?>
	<input type='text' name='wpspx_settings[wpspx_text_field_0]' value='<?php echo $options['wpspx_text_field_0']; ?>'>
	<?php

}

// Client API Key
function wpspx_text_field_1_render(  ) {

	$options = get_option( 'wpspx_settings' );
	?>
	<input type='text' name='wpspx_settings[wpspx_text_field_1]' value='<?php echo $options['wpspx_text_field_1']; ?>'>
	<?php

}

// Custom URL
function wpspx_text_field_2_render(  ) {

	$options = get_option( 'wpspx_settings' );
	?>
	<input type='text' name='wpspx_settings[wpspx_text_field_2]' value='<?php echo $options['wpspx_text_field_2']; ?>'>
	<?php

}

// Path to CRT
function wpspx_text_field_3_render(  ) {

	$options = get_option( 'wpspx_settings' );
	?>
	<input type='text' name='wpspx_settings[wpspx_text_field_3]' value='<?php echo $options['wpspx_text_field_3']; ?>'>
	<?php

}

// Path to KEY
function wpspx_text_field_4_render(  ) {

	$options = get_option( 'wpspx_settings' );
	?>
	<input type='text' name='wpspx_settings[wpspx_text_field_4]' value='<?php echo $options['wpspx_text_field_4']; ?>'>
	<?php
...
function wpspx_settings_section_callback(  ) {
	...
	echo __( 'This section description', 'wpspx' );
